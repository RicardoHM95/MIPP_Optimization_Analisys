...
solver.options['seconds'] = 24*3600
...
# --- Exportar a Excel ---
nombre_archivo = 'Resultados_Optimizacion_random_1dia.xlsx'
...
print(f"\n>>> Resultados exportados exitosamente a '{nombre_archivo}' en las hojas '{nombre_hoja}' y '{nombre_hoja_final}'.")
